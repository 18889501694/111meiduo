...
class SPU(BaseModel):
    ...
    desc_detail = models.TextField(default='', verbose_name='详细评价')
...
class SKU(BaseModel):
    ...
    cost_price = models.DecimalField(max_length=10, decimal_places=2, verbose_name='进价')
    market_price = models.DecimalField(max_length=10, decimal_places=2, verbose_name='市场价')
...
class SpecificationOption(BaseModel):
    """规格选项"""
    spec = models.ForeignKey(SPUSpecification, related_name='options', on_delete=models.CASCADE, verbose_name='spec')
